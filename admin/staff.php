...
<body style="background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="add-delete">
       <a href="addform_staff.php"> <button class="btn btn-primary btn-sm" id="add"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Staff</button></a>
    ...
    <div class="grid">
        ...
        <table class="table-box">
            <thead>
                <tr>                   
                    <th style="background-color: #f9dcc4; text-align: center;">NAME</th>
            ...
            <tbody>
                <?php
                    $sql = mysqli_query($link, "select * from staff where Type ='active' ");
                ...
                echo '
                    ...
                    <td style="text-align: center; padding: 2px;">';
                        ...
                        echo "<button type='submit' class='btn btn-primary btn-sm' id='edit'><a href='updateform_staff.php?id=$id&name=$name&username=$username&password=$password' style='color:white';>
                        Edit</a></button>";

                        echo "<button type='submit' class='btn btn-danger btn-sm' id='archive'>
                        <a href='archive_staff.php?id=$id&Type=$Type' style='color:white';>
                        Archive</a></button>";
