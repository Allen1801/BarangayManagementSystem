...
<body style="background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="add-delete">
        <a href="addform_permit.php"><button class="btn btn-primary btn-sm" id="add"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Permit</button></a>
    </div>
                    ...
                    while($row = mysqli_fetch_array($sql))
                    {
                        ...
                        <td>' .$row['date'].  '</td>
                            ...
                            <td style="text-align: center; padding: 2px;">';
                                ...
                                <a href='updateform_permit.php?id=$id&resident=$resident&businessname=$businessname&address=$address&type='$type'&orno='$orno'&amount='$amount' style='color:white';>
                                Edit</a></button>";

                                echo "<button type='submit' class='btn btn-danger btn-sm' id='archive'>
                                <a href='archive_permit.php?id=$id&status=$status' style='color:white';>
                                Archive</a></button>";
