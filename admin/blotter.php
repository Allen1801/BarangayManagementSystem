...
<body style="background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="add-delete">
        <a href="addform_blotter.php"><button class="btn btn-primary btn-sm" id="add" ><i class="fa fa-user-plus" aria-hidden="true"></i> Add Blotter</button></a>
        ...
        <table class="table-box">
            <thead>
                <tr>                   
                    ...
                    <th style="background-color: powderblue; text-align: center;">COMPLAINT</th>
                    <th style="background-color: #f9dcc4; text-align: center;">ACTION TAKEN</th>
                    <th style="background-color: powderblue; text-align: center;">STATUS</th>
                    <th style="background-color: #f9dcc4; text-align: center;">LOCATION OF INCIDENTS</th>
                    ...
                    while($row = mysqli_fetch_array($sql))
                    {
                        ...
                        echo '
                            ...
                            <td style="text-align: center; padding: 2px;">';
                                ...
                                <a href='updateform_blotter.php?id=$id&date=$date&complainant=$complainant&complainee=$complainee&complaint=$complaint&status=$status&location=$location&action=$action' style='color:white';>
                                Edit</a></button>";

                                echo "<button type='submit' class='btn btn-danger btn-sm' id='archive'>
                                <a href='archive_blotter.php?id=$id&type=$type' style='color:white';>
                                Archive</a></button>";
