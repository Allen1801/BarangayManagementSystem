...
<body style = "background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;" >
	...
	<form class= "form" action = "insert_blotter.php" method = "POST">
         ...
         <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">DATE : </p>
          <input type="date" class="name" placeholder="Last Name, First Name, Middle Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="date">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">COMPLAINANT : </p>
          <input type="text" class="name" placeholder="Last Name, First Name, Middle Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="p1">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">COMPLAINEE : </p>
          <input type="text" class="username" placeholder="Last Name, First Name, Middle Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="p2">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">COMPLAINT : </p>
          <input type="text" class="number" placeholder="Complaint" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="complain">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">ACTION : </p>
          <input type="text" class="username" placeholder="Action" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="act">
          
          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">STATUS : </p>
          <div>
          <select name="status" class="name" style="width: 450px; margin-bottom: 10px; height: 23px; margin-left: 110px;" name="status">
          ...
          <input type="text" class="number" placeholder="Complaint" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="location">
