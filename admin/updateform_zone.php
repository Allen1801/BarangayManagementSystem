...
<body style = "background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;" >
	...
	<form class= "form" action = "update_zone.php" method = "POST">
         ...
         <input type="hidden" value="<?php echo $id; ?>" name="hidden_id" id="hidden_id">
          ...
          <input type="text" class="name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="zone" value="<?php echo $N; ?>" autocomplete ="off">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">USERNAME : </p>
          <input type="text" class="username" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="username" value="<?php echo $U; ?>" autocomplete ="off">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">PASSWORD : </p>
          <input type="password" class="number" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" name="password" value="<?php echo $P; ?>" autocomplete ="off">
          </div>
