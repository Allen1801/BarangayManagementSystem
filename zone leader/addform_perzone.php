...
<body style = "background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;" >
    ...
    <form class= "form" action="add_perfunction.php" method="POST">
         ...
         <h3 style="margin-top:10px; margin-left: 6px;">__________________________________________________</h3>
          ...
          <input type="text" name="name" class="name" placeholder="Last Name, First Name, Middle Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;" >

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">BUSINESS NAME : </p>
          <input type="text" name="bname" class="username" placeholder="Business Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">BUSINESS ADDRESS : </p>
          <input type="text" name="address" class="number" placeholder="Business Address" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">TYPE OF BUSINESS : </p>
          <input type="text" name="type" class="username" placeholder="Type of Business" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">

           <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">OR NUMBER : </p>
          <input type="text" name="orno" class="username" placeholder="OR Number" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">
          
          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">AMOUNT :  </p>
          <input type="text" name="amount" class="number" placeholder="Amount" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">
        </div>
