...
<body style="background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="add-delete">
       <a href="addform_per.php"> <button class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i> Request Permit</button></a>
    </div>
        ...
        <table class="table-box">
            <thead>
                <tr>    
                    ...
                    <th style="background-color: #f9dcc4; text-align: center;">BUSINESS NAME</th>
                    <th style="background-color: powderblue; text-align: center;">BUSINESS ADDRESS</th>
                    <th style="background-color: #f9dcc4; text-align: center;">TYPE OF BUSINESS</th>
                </tr>
            </thead>
            <tbody>
                <?php
