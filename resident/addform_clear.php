...
<html>
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" href="../css/res_clear.css">
...
<body style = "background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;" >
	...
	<form class= "form" action="add_clearfunction.php" method="POST">
          <img src="../images/logo.png" style="height: 100px; width: 100px; margin-top: 20px; margin-left: 57px;">
          <h1 style="margin-left: 173px; margin-top: -69px; font-size: 40px; font-weight: bolder;">REQUEST CLEARANCE</h1>
         ...
         <div style="margin-left: 10px;">
          ...
          <input type="text" name="resident" class="number" placeholder="Last Name, First Name, Middle Name" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">

          <p style="margin-bottom: 0px; font-weight: bolder; margin-left: 110px;">PURPOSE : </p>
          <input type="text" name="purpose" class="number" placeholder="Purpose" style="width: 450px; margin-bottom: 10px; margin-left: 110px;">
          </div>
          ...
          <div class="buttons" style="margin-left: -110px;">
          	<a href="res_clear.php"><input type="button" class="cancel" value="BACK" style="margin-left: 235px;" ></a>
