...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" href="../css/res_blotter.css">
...
<body style="background-image: url(../images/main.png); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="add-delete">
      <a href="addform_blot.php">  <button class="btn btn-primary btn-sm" id="add" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Blotter</button> </a>
    </div>
        ...
        <table class="table-box">
            <thead>
                <tr>                   
                    ...
                    <th style="background-color: #f9dcc4; text-align: center;">PERSON TO COMPLAINT</th>
            ...
            <tbody>
                ...
                echo '
                    ...
                    <td style="text-align: center; padding: 2px;">';
                        echo "<button type='submit' class='btn btn-primary btn-sm' id='edit'> <a href='editform_blot.php?id=$id&complainant=$complainant&complainee=$complainee&complaint=$complaint&location=$location' style='color:white;'>Edit</a></button>";
                   echo '</td>
                </tr>';
                    }
                    ?>
